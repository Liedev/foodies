...
namespace Foodies.Controllers.API
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<object> Authenticate([FromBody] ApiUser apiUser)
        {
            ...
            {
                ApplicationUser applicationUser = _userManager.Users.SingleOrDefault(r => r.Email == apiUser.UserName);
                apiUser.Token = GenerateJwtToken(apiUser.UserName, applicationUser).ToString();
        ...
        private string GenerateJwtToken(string email, ApplicationUser applicationUser)
        {
